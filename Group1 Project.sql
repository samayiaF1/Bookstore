...
INSERT INTO `bookstore`.`publisher` (`publisher_id`, `name`, `address`, `phone`) VALUES ('03', 'newbook', 'pubadd', '123');
INSERT INTO `bookstore`.`publisher` (`publisher_id`, `name`, `address`, `phone`) VALUES ('07', 'lenguine', 'pubadd', '123');
INSERT INTO `bookstore`.`publisher` (`publisher_id`, `name`, `address`, `phone`) VALUES ('01', 'boli', 'pubadd', '123');
INSERT INTO `bookstore`.`publisher` (`publisher_id`, `name`, `address`, `phone`) VALUES ('08', 'mnn', 'pubadd', '123');
INSERT INTO `bookstore`.`publisher` (`publisher_id`, `name`, `address`, `phone`) VALUES ('09', 'bimes', 'pubadd', '123');
INSERT INTO `bookstore`.`author` (`author_id`, `name`, `address`, `phone`, `email`) VALUES ('1', 'Bario Huzo', 'Bario', '0000', 'Bario@gmail');
INSERT INTO `bookstore`.`author` (`author_id`, `name`, `address`, `phone`, `email`) VALUES ('2', 'Ceo Lolstoy', 'Ceo', '0000', 'ceo@gmail');
INSERT INTO `bookstore`.`author` (`author_id`, `name`, `address`, `phone`, `email`) VALUES ('3', 'Aabriel Marcía Márquez', 'Aabrial', '0000', 'aab@gmail');
INSERT INTO `bookstore`.`author` (`author_id`, `name`, `address`, `phone`, `email`) VALUES ('4', 'Tylvia Blath', 'Tlyviya', '0000', 't@gmail');
